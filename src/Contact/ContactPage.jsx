   ...
   <form onSubmit={handleSubmit} className="space-y-6">
     ...
     <motion.button
       ...
       className="w-full px-8 py-4 rounded-lg bg-saber-600 text-white font-medium
                ...
                focus:ring-offset-2 focus:ring-offset-black transition-all duration-200
 ...
 return (
   ...
   >
     <div className="flex items-center gap-4">
       <div className="rounded-full bg-saber-500/20 p-3">
         <RiDownloadLine className="w-8 h-8 text-saber-400" />
       </div>
       <div className="text-left">
         <h4 className="text-lg font-medium text-white">Download Resume</h4>
...
const SocialLink = ({ href, icon: Icon, label, colorClass }) => (
 <motion.a
   ...
   className={`flex items-center gap-3 px-6 py-4 rounded-lg bg-white/10 
            border border-white/20 hover:bg-white/15 transition-all duration-300 group shadow-md ${colorClass}`}
 >
        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              className="h-0.5 bg-gradient-to-r from-saber-500/30 via-saber-400/50 to-saber-500/30 mx-auto mb-6"
            />
